...
private ArrayList<Collection<Collection<Collection<Integer>>>> data;
public array3d() {
...
public void addData(Collection<Collection<Collection<Integer>>> x) {
data.add(x);
}
public Collection<Collection<Collection<Integer>>> getData(int index) {
return data.get(index);
}
public void setData(int index, Collection<Collection<Collection<Integer>>> x) {
data.set(index, x);
}
