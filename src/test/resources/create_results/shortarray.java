...
private ArrayList<Collection<Collection<Collection<Short>>>> data;
public shortarray() {
...
public void addData(Collection<Collection<Collection<Short>>> x) {
data.add(x);
}
public Collection<Collection<Collection<Short>>> getData(int index) {
return data.get(index);
}
public void setData(int index, Collection<Collection<Collection<Short>>> x) {
data.set(index, x);
}
